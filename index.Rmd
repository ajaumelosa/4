...
# Results
  ...
  * Total duration of voiceless interval was significantly longer in hC-sequences than in intervocalic stops for both varieties and age groups. Also, the total duration of hC-sequences is very stable across varieties, place of articulation, and age groups: not affected by sound change.
  
  * No effect of age or variety on the duration of the preceding vowel, suggesting that the glottal opening gesture does not take place later in time in younger than in older speakers. Contrary, vowels were slightly shorter when followed by a phonological /s/ + voiceless stop than when preceding intervocalic stops. This still does not support the assumption of vowel lengthening as a compensation for /s/ lenition.
...
* Psychometric curves of younger listeners appear to be steeper than those of the older listeners.
